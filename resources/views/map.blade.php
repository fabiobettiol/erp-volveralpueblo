...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
		<div class="loading fa-solid fa-spinner fa-spin-pulse fa-4x" style="position: absolute; top:  45%; left: 45%; color: #DDD; z-index: -1"></div>
        ...
        <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBroabFHjAXY0mL7-Pl9feeVcyaEOTJ0DU&callback=initMap"></script>
