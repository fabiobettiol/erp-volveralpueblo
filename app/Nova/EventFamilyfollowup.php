...
class EventFamilyfollowup extends Resource
{
	...
	public static function label() {
        return 'Seguimiento (F)';
    }

    /**
     * The model the resource corresponds to.
     *
     * @var class-string<\App\Models\EventFamilyfollowup>
     */
    public static $model = \App\Models\EventFamilyfollowup::class;
